...
static const ber_tlv_tag_t asn_DEF_TrajectoryMCM_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_TrajectoryMCM_specs_1 = {
	sizeof(struct TrajectoryMCM),
	offsetof(struct TrajectoryMCM, _asn_ctx),

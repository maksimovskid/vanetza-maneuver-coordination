...
int
OpeningDaysHours_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
OpeningDaysHours_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
OpeningDaysHours_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	OpeningDaysHours_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
OpeningDaysHours_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
OpeningDaysHours_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
OpeningDaysHours_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
OpeningDaysHours_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
OpeningDaysHours_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_OpeningDaysHours = {
	"OpeningDaysHours",
	"OpeningDaysHours",
	OpeningDaysHours_free,
	OpeningDaysHours_print,
	OpeningDaysHours_constraint,
	OpeningDaysHours_decode_ber,
	OpeningDaysHours_encode_der,
	OpeningDaysHours_decode_xer,
	OpeningDaysHours_encode_xer,

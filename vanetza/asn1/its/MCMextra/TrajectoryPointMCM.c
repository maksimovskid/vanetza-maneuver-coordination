...
static asn_TYPE_member_t asn_MBR_TrajectoryPointMCM_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TrajectoryPointMCM, deltaLongitudinalPosition),
...
static const ber_tlv_tag_t asn_DEF_TrajectoryPointMCM_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TrajectoryPointMCM_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_TrajectoryPointMCM_specs_1 = {
	sizeof(struct TrajectoryPointMCM),
	offsetof(struct TrajectoryPointMCM, _asn_ctx),

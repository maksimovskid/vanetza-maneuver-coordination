...
int
ShadowingApplies_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
ShadowingApplies_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
ShadowingApplies_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ShadowingApplies_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
ShadowingApplies_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
ShadowingApplies_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ShadowingApplies_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
ShadowingApplies_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ShadowingApplies_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_ShadowingApplies = {
	"ShadowingApplies",
	"ShadowingApplies",
	ShadowingApplies_free,
	ShadowingApplies_print,
	ShadowingApplies_constraint,
	ShadowingApplies_decode_ber,
	ShadowingApplies_encode_der,
	ShadowingApplies_decode_xer,
